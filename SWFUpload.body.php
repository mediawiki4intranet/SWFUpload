...
class SpecialSWFUpload extends SpecialPage
{
    ...
    public function execute($par)
    {
        ...
        $sizelimit = 102400;
        $vars = array();
        foreach (split(' ', 'allfiles pending uploading finished cancelled upload-stopped queue-limit-exceeded-0 queue-limit-exceeded-1 queue-limit-exceeded-2 '.
...
<table>
    ...
    <tr><td colspan="2" align="right">$msg_select_file <span id="spanButtonPlaceholder1"></span> <input id="btnCancel1" type="button" value="Отменить" onclick="upload1.cancelQueue();" disabled="disabled" style="width: 61px; margin: 0 0 0 2px; padding: 0; height: 22px; font-size: 8pt;" /></td></tr>
</table>
