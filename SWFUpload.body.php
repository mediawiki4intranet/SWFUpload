...
<table>
    ...
    <tr><td>$msg_name_prefix</td><td><input id="swfuploadNamePrefix" type="text" style="width:100%" onchange="upload1.addPostParam('swfuploadNamePrefix', this.value)" value="$def_prefix" /></td></tr>
